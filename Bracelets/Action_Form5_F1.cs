...
namespace Bracelet
{
    public partial class Action_Form5_F1 : Form
    {
        public Action_Form5_F1()
        {
            InitializeComponent();
        }

        private void Action_Form5_F1_Load(object sender, EventArgs e)
        {
        ...
        private void dgvBrac_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {

        }

        private void Action_Form5_F1_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
    }
