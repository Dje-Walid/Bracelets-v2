...
namespace Bracelet
{
    public partial class Aide_Form1 : Form
    {
        public Aide_Form1()
        {
            InitializeComponent();
        ...
        private void archivageDuneCampagneToolStripMenuItem_Click_1(object sender, EventArgs e)
        {

        }

        private void importationDeLaFédérationToolStripMenuItem_Click_1(object sender, EventArgs e)
        {

        }

        private void exportationVersLaDDAFToolStripMenuItem_Click_1(object sender, EventArgs e)
        {

        }

        private void importationDeLaDDAFToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
        ...
        private void Aide_Form1_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
    }
