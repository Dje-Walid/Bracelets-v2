...
namespace Bracelet
{
    public partial class Edition_Form3_F3 : Form
    {
        public Edition_Form3_F3()
        {
            InitializeComponent();
        }
        ...
        private void statistiquesToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
        ...
        private void Edition_Form3_F3_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
    }
