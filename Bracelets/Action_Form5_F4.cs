...
namespace Bracelet
{
    public partial class Action_Form5_F4 : Form
    {
        public Action_Form5_F4()
        {
            InitializeComponent();
        }

        private void Action_Form5_F4_Load(object sender, EventArgs e)
        {
        ...
        private void Action_Form5_F4_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
    }
